...
import { saveRoute } from "@/components/RecentRoutes";
  ...
  const handleCalculateRoute = async () => {
    ...
    try {
      ...
      if (response.path && response.path.length > 0) {
        ...
        // ADD THIS: Save route to localStorage
        if (response.distance && response.estimatedTime) {
          saveRoute(
            startPoint.lat,
            startPoint.lon,
            endPoint.lat,
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Plan optimal maritime routes with real-time data</p>
        </div>
